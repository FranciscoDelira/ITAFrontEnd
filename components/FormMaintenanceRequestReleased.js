...
function FormMaintenanceRequestReleased(){
        ...
        <VStack height="100%" width="100%" space={4} _dark={{bg:"tema.3"}} _light={{bg:"tema.2"}}>
            ...
            <Box height="70%" w="90%" alignSelf="center">
                ...
                <Text _dark={{color: "tema.2"}} _light={{color: "tema.3"}} fontSize="xl" bold>Evidencia: </Text>
                    ...
                    <Image source={require("../assets/Isaac1.png")} size="md"/>
                    <Image source={require("../assets/Isaac2.png")} size="md"/>
                    <Image source={require("../assets/Isaac1.png")} size="md"/>
                    </HStack>
...
export default FormMaintenanceRequestReleased;