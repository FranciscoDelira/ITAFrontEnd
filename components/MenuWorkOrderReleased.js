        ...
        <VStack height="100%" width="100%" space={4} _dark={{ bg: "tema.3" }} _light={{ bg: "tema.2" }}>
            ...
            <Box height="55%" w="90%" alignSelf="center" >
                {workOrderR.map((WOReleased) => (
                    <Box _dark={{ bg: "tema.2", color: "tema.3" }} _light={{ bg: "tema.3", color: "tema.2" }} _pressed={{ bg: 'tema.6' }} borderRadius="xl" height={"150px"} marginBottom="5%" padding={"3%"} key={WOReleased.id}>
