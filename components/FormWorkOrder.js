...
import { VStack, Text, Heading, Image, Box, HStack, AlertDialog, Button, TextArea, Input } from "native-base";
    ...
    return (
        <VStack height="100%" width="100%" space={4} >
            ...
            <Box height="70%" w="90%" alignSelf="center">
                ...
                <Input _dark={{ bg: "tema.2", color: "tema.3", placeholderTextColor: "tema.3" }} _light={{ bg: "tema.3", color: "tema.2", placeholderTextColor: "tema.2" }} borderColor="tema.1" fontSize="md" _focus={{ bg: "tema.6", borderColor: "tema.1" }} placeholder="Descripción del trabajo" p="2" height="15%" />
