        ...
        <VStack height="100%" width="100%" space={4} _dark={{bg:"tema.3"}} _light={{bg:"tema.2"}}>
            ...
            <Box height="70%" w="90%" alignSelf="center">
                ...
                <Text _dark={{color: "tema.2"}} _light={{color: "tema.3"}} fontSize="xl" bold>Evidencia: </Text>
                    ...
                    <Image source={require("../assets/Isaac1.png")} alt="image" size="md"/>
                    <Image source={require("../assets/Isaac2.png")} alt="image2" size="md"/>
                    <Image source={require("../assets/Isaac1.png")} alt="image3" size="md"/>
                    </HStack>
                ...
                <Text _dark={{color: "tema.2"}} _light={{color: "tema.3"}} fontSize="xl" bold>Evidencia de Trabajo: </Text>
                    <HStack justifyContent={"center"}>
                    <Image source={require("../assets/Isaac1.png")} alt="imagen" size="md"/>
                    <Image source={require("../assets/Isaac2.png")} alt="imagen2" size="md"/>
                    <Image source={require("../assets/Isaac1.png")} alt="imagen3" size="md"/>
                    </HStack>
